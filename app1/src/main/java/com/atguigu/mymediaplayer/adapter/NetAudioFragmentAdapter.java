package com.atguigu.mymediaplayer.adapter;
...
import com.atguigu.mymediaplayer.attribute.ADHolder;
import com.atguigu.mymediaplayer.attribute.GifHolder;
import com.atguigu.mymediaplayer.attribute.ImageHolder;
import com.atguigu.mymediaplayer.attribute.TextHolder;
import com.atguigu.mymediaplayer.attribute.VideoHoder;
...
public class NetAudioFragmentAdapter extends BaseAdapter {
    ...
    private final List<ListBeanItem.ListBean> datas;


    public NetAudioFragmentAdapter(Context mContext, List<ListBeanItem.ListBean> datas) {
    ...
    public int getItemViewType(int position) {
        int itemViewType = -1;
        //根据位置，从列表中得到一个数据对象
        ListBeanItem.ListBean listBean = datas.get(position);
    ...
    private View initView(View convertView, int itemViewType, ListBeanItem.ListBean mediaItem) {
        switch (itemViewType) {
            case TYPE_VIDEO://视频
